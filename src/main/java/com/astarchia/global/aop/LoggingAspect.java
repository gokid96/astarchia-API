package com.astarchia.global.aop;
...
public class LoggingAspect {
    ...
    // 컨트롤러 로깅
    @Around("execution(* com.astarchia.domain.*.controller..*(..))")
    ...
    @Around("execution(* com.astarchia.domain.*.service..*(..))")
    ...
    @Around("execution(* com.astarchia.domain.*.repository..*(..))")
