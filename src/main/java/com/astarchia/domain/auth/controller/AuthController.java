package com.astarchia.domain.auth.controller;

import com.astarchia.domain.auth.dto.response.LoginResponse;
import com.astarchia.domain.auth.service.AuthService;
...
public class AuthController {
    ...
    public ResponseEntity<Map<String, Object>> getCurrentUser(HttpSession session) {
        ...
        var userDetails = (com.astarchia.global.security.CustomUserDetails) authentication.getPrincipal();
